...
class NewsUpdateAction
{
    ...
    public function __invoke(Request $request, Response $response, array $args): Response
    {
        ...
        if (!empty($content)) {
            $this->newsService->update($id, $content, $topic);
        }
        ...
        // OOB flash injection - works even with outerHTML swap
        $flash = '<div id="flash-container" hx-swap-oob="beforeend"><div class="alert-success">Hír sikeresen módosítva!</div></div>';
